...
---@field base_flags flag-bit
---@field pad_1 padding needed for proper alignment of spatter on gcc
...
---@class item_corpsest
---@field unused_380 pointer
---@field unused_388 pointer
---@field unused_390 pointer
...
---@field handedness df-flagarray 1 right, 2 left
