...
---@type table<geo_layer_type, geo_layer_type_attr>
...
---@class world_object_data_picked_growths
...
---@class world_object_data_unk_v43
...
---@field unk_1 uint32_t # align(width,4)*height
---@field unk_2 uint32_t # align(width,4)*height
---@field unk_3 uint32_t # width*height
---@field unk_4 uint8_t # align(width,4)*height
