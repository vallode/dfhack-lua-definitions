...
df.misc_trait_type = {
  ...
  RoomComplaint = 8,
  UnnamedResident = 9,
  RentBedroomCooldown = 10,
  ClaimTrinketCooldown = 11,
  ClaimClothingCooldown = 12,
  WantsDrink = 13,
  unk_14 = 14,
  unk_15 = 15,
  unk_16 = 16,
  ...
  unk_22 = 22,
  unk_23 = 23,
  FollowUnitCooldown = 24,
  unk_25 = 25,
  unk_26 = 26,
  unk_27 = 27,
  DangerousTerrainCooldown = 28,
  Beaching = 29,
  IdleAreaCooldown = 30,
  unk_31 = 31,
  PartiedOut = 32,
  DiagnosePatientCooldown = 33,
  DressWoundCooldown = 34,
  CleanPatientCooldown = 35,
  SurgeryCooldown = 36,
  SutureCooldown = 37,
  SetBoneCooldown = 38,
  PlaceInTractionCooldown = 39,
  ApplyCastCooldown = 40,
  ImmobilizeBreakCooldown = 41,
  BringCrutchCooldown = 42,
  unk_43 = 43,
  MilkCounter = 44,
  HadDrill = 45,
  CompletedDrill = 46,
  EggSpent = 47,
  GroundedAnimalAnger = 48,
  unk_49 = 49,
