...
---@field minval df.container ?
---@field maxval df.container ?
---@field required df.container
...
---@field forbidden_creature_flags df.container contains indexes of flags in creature_raw_flags
---@field required_caste_flags df.container contains indexes of flags in caste_raw_flags
---@field forbidden_caste_flags df.container contains indexes of flags in caste_raw_flags
---@field unk_1 integer
---@field unk_2 integer
