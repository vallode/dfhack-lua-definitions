...
---@field STOCKPILE any
---@field ANY_ZONE any
---@field ACTIVITY_ZONE any
---@field ZONE_HOME any
---@field ZONE_DEPOT any
---@field ZONE_STOCKPILE any
---@field ZONE_NOBLE_QUARTERS any
---@field ZONE_INVALID4 any
---@field ZONE_INVALID5 any
---@field ZONE_INVALID6 any
---@field ZONE_MEAD_HALL any
---@field ZONE_THRONE_ROOM any
---@field ZONE_INVALID9 any
---@field ZONE_TEMPLE any
---@field ZONE_KITCHEN any
---@field ZONE_CAPTIVE_ROOM any
---@field ZONE_TOWER_TOP any
---@field ZONE_COURTYARD any
---@field ZONE_TREASURY any
---@field ZONE_GUARD_POST any
---@field ZONE_ENTRANCE any
---@field ZONE_SECRET_LIBRARY any
---@field ZONE_LIBRARY any
---@field ZONE_PLOT any
---@field ZONE_MARKET_STALL any
---@field ZONE_INVALID22 any
---@field ZONE_CAMPGROUND any
---@field ZONE_COMMAND_TENT any
---@field ZONE_TENT any
---@field ZONE_COMMAND_TENT_BLD any
---@field ZONE_TENT_BLD any
---@field ZONE_MECHANISM_ROOM any
---@field ZONE_DUNGEON_CELL any
---@field ZONE_ANIMAL_PIT any
---@field ZONE_CLOTH_PIT any
---@field ZONE_TANNING_PIT any
---@field ZONE_CLOTH_CLOTHING_PIT any
---@field ZONE_LEATHER_CLOTHING_PIT any
---@field ZONE_BONE_CARVING_PIT any
---@field ZONE_GEM_CUTTING_PIT any
---@field ZONE_WEAPONSMITHING_PIT any
---@field ZONE_BOWMAKING_PIT any
---@field ZONE_BLACKSMITHING_PIT any
---@field ZONE_ARMORSMITHING_PIT any
---@field ZONE_METAL_CRAFTING_PIT any
---@field ZONE_LEATHERWORKING_PIT any
---@field ZONE_CARPENTRY_PIT any
---@field ZONE_STONEWORKING_PIT any
---@field ZONE_FORGING_PIT any
---@field ZONE_FIGHTING_PIT any
---@field ZONE_INVALID47 any
---@field ZONE_INVALID48 any
---@field ZONE_INVALID49 any
---@field ZONE_INVALID50 any
---@field ZONE_INVALID51 any
---@field ZONE_INVALID52 any
---@field ZONE_ANIMAL_WORKSHOP any
---@field ZONE_CLOTH_WORKSHOP any
---@field ZONE_TANNING_WORKSHOP any
---@field ZONE_CLOTH_CLOTHING_WORKSHOP any
---@field ZONE_LEATHER_CLOTHING_WORKSHOP any
---@field ZONE_BONE_CARVING_WORKSHOP any
---@field ZONE_GEM_CUTTING_WORKSHOP any
---@field ZONE_WEAPONSMITHING_WORKSHOP any
---@field ZONE_BOWMAKING_WORKSHOP any
---@field ZONE_BLACKSMITHING_WORKSHOP any
---@field ZONE_ARMORSMITHING_WORKSHOP any
---@field ZONE_METAL_CRAFTING_WORKSHOP any
---@field ZONE_LEATHERWORKING_SHOP any
---@field ZONE_CARPENTRY_WORKSHOP any
---@field ZONE_STONEWORKING_WORKSHOP any
---@field ZONE_FORGING_WORKSHOP any
---@field ZONE_COUNTING_HOUSE_OFFICES any
---@field ZONE_COUNTING_HOUSE_STORAGE any
---@field ZONE_GUILDHALL_OFFICES any
---@field ZONE_GUILDHALL_STORAGE any
---@field ZONE_TOWER_ENTRANCE any
---@field ZONE_TOWER_FEASTHALL any
---@field ZONE_TOWER_BEDROOM any
---@field ZONE_TOWER_TREASURY any
---@field ZONE_TOWER_DUNGEON any
---@field ZONE_TOWER_ATTIC any
---@field ZONE_DORMITORY any
---@field ZONE_DINING_HALL any
---@field ZONE_INVALID81 any
---@field ZONE_WATER_SOURCE any
---@field ZONE_DUMP any
---@field ZONE_SAND_COLLECTION any
---@field ZONE_FISHING_AREA any
---@field ZONE_POND any
---@field ZONE_MEETING_HALL any
---@field ZONE_PEN any
---@field ZONE_CLAY_COLLECTION any
---@field ZONE_ANIMAL_TRAINING any
---@field ZONE_PLANT_GATHERING any
---@field ZONE_BEDROOM any
---@field ZONE_OFFICE any
---@field ZONE_ARCHERY_RANGE any
---@field ZONE_BARRACKS any
---@field ZONE_DUNGEON any
---@field ZONE_TOMB any
---@field LOCATION_ASSIGNED any
---@field ANY_ACTUAL any
---@field ANY_MACHINE any
---@field ANY_HOSPITAL_STORAGE any
---@field ANY_STORAGE any
---@field ANY_BARRACKS any
---@field ANY_HOSPITAL any
---@field BOX any
---@field CABINET any
---@field TRAP any
---@field DOOR any
---@field FLOODGATE any
---@field HATCH any
---@field GRATE_WALL any
---@field GRATE_FLOOR any
---@field BARS_VERTICAL any
---@field BARS_FLOOR any
---@field WINDOW_ANY any
---@field WELL any
---@field TABLE any
---@field BRIDGE any
---@field CHAIR any
---@field TRADE_DEPOT any
---@field NEST any
---@field NEST_BOX any
---@field BOOKCASE any
---@field DISPLAY_CASE any
---@field HIVE any
---@field WAGON any
---@field SHOP any
---@field BED any
...
---@field ANY_ROAD any
---@field FARM_PLOT any
---@field GEAR_ASSEMBLY any
---@field ROLLERS any
---@field AXLE_HORIZONTAL any
---@field AXLE_VERTICAL any
---@field SUPPORT any
---@field ARCHERY_TARGET any
---@field SCREW_PUMP any
---@field WATER_WHEEL any
---@field WINDMILL any
---@field CHAIN any
---@field CAGE any
---@field STATUE any
---@field SLAB any
---@field COFFIN any
---@field WEAPON_RACK any
---@field ARMOR_STAND any
---@field FURNACE_ANY any
---@field FURNACE_WOOD any
---@field FURNACE_SMELTER_ANY any
---@field FURNACE_SMELTER_MAGMA any
---@field FURNACE_KILN_ANY any
---@field FURNACE_GLASS_ANY any
---@field FURNACE_CUSTOM any
---@field WORKSHOP_ANY any
---@field WORKSHOP_BUTCHER any
---@field WORKSHOP_MASON any
---@field WORKSHOP_KENNEL any
---@field WORKSHOP_FISHERY any
---@field WORKSHOP_JEWELER any
---@field WORKSHOP_LOOM any
---@field WORKSHOP_TANNER any
---@field WORKSHOP_DYER any
---@field WORKSHOP_MILL_ANY any
---@field WORKSHOP_QUERN any
---@field WORKSHOP_TOOL any
---@field WORKSHOP_MILLSTONE any
---@field WORKSHOP_KITCHEN any
---@field WORKSHOP_STILL any
---@field WORKSHOP_FARMER any
---@field WORKSHOP_ASHERY any
---@field WORKSHOP_CARPENTER any
---@field WORKSHOP_CRAFTSDWARF any
---@field WORKSHOP_MECHANIC any
---@field WORKSHOP_SIEGE any
---@field WORKSHOP_CLOTHIER any
---@field WORKSHOP_LEATHER any
---@field WORKSHOP_BOWYER any
---@field WORKSHOP_MAGMA_FORGE any
---@field WORKSHOP_FORGE_ANY any
---@field WORKSHOP_CUSTOM any
---@field WEAPON_UPRIGHT any
---@field INSTRUMENT_STATIONARY any
---@field OFFERING_PLACE any
