...
---@field ZoneRepaint 127
---@field [127] "ZoneRepaint"
---@field ZoneSuspend 129
---@field [129] "ZoneSuspend"
---@field ZoneRemove 130 130
---@field [130] "ZoneRemove" 130
---@field ZoneAssignLocation 138
---@field [138] "ZoneAssignLocation"
...
---@field ZoneRepaint { caption: "Repaint this zone." }
---@field ZoneSuspend { caption: "Suspend activities in this zone. Does not remove the zone." }
---@field ZoneRemove { caption: "Remove this zone permanently." }
---@field ZoneAssignLocation { caption: "Assign a new or existing location to this zone. Locations are groups of zones and rooms with a larger purpose, like a tavern, a temple, a library, or a craft guildhall." }
