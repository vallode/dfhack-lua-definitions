...
---@alias df.d_init_flags3
---| 0 # COFFIN_NO_PETS_DEFAULT

---@class identity.d_init_flags3: DFEnumType
...
---@field wound_color df.d_init.T_wound_color
---@field show_embark_tunnel df.d_init_tunnel probably IDLERS
...
---@field store_dist df.d_init.T_store_dist
...
---@class (exact) df.d_init.T_wound_color: DFStruct
---@field _type identity.d_init.wound_color
---@field none number[]
---@field minor number[]
...
---@class identity.d_init.wound_color: DFCompoundType
---@field _kind 'struct-type'
df.d_init.T_wound_color = {}

---@return df.d_init.T_wound_color
function df.d_init.T_wound_color:new() end

---@class _d_init_flags3: DFContainer
---@field [integer] table<df.d_init_flags3, boolean>
local _d_init_flags3

---@nodiscard
---@param index integer
---@return DFPointer<table<df.d_init_flags3, boolean>>
function _d_init_flags3:_field(index) end

---@param index '#'|integer
---@param item table<df.d_init_flags3, boolean>
function _d_init_flags3:insert(index, item) end

---@param index integer
function _d_init_flags3:erase(index) end

---@class (exact) df.d_init.T_store_dist: DFStruct
---@field _type identity.d_init.store_dist
...
---@class identity.d_init.store_dist: DFCompoundType
---@field _kind 'struct-type'
df.d_init.T_store_dist = {}

---@return df.d_init.T_store_dist
