...
---@class _d_init_embark_confirm: df.enum
---@field ALWAYS 0
---@field [0] "ALWAYS"
...
---@class _d_init_autosave: df.enum
---@field NONE -1
---@field [0] "NONE"
---@field SEASONAL 1
---@field [1] "SEASONAL"
