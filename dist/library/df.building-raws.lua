...
---@field item_type building_def_item_item_type
...
---@field has_tool_use building_def_item_has_tool_use
---@field item_str string[]
---@field material_str string[]
---@field metal_ore_str string
df.building_def_item = {}

---@enum building_def_item_item_type
df.building_def_item.T_item_type = {
}

---@enum building_def_item_tool_uses
df.building_def_item.T_tool_uses = {
}
