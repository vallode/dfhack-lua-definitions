...
local state_profilest

---@class _state_profilest: DFCompound
---@field _kind 'struct-type'
df.state_profilest = {}

---@alias _state_profilest.T_flags_keys
---| 0 # XY_LOCATION_SMM_LEVEL
---| 1 # XY_LOCATION_IN_SUL

---@alias _state_profilest.T_flags_values
---| "XY_LOCATION_SMM_LEVEL" # 0
---| "XY_LOCATION_IN_SUL" # 1

---@class state_profilest.T_flags: DFObject, { [_state_profilest.T_flags_keys|_state_profilest.T_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _state_profilest.T_flags
local state_profilest_flags = {
...
local knowledge_profilest_opinion_info
...
---@field unk_2 number
local historical_figure_relationships
...
local historical_figure_vector
...
---@field unk_1 number
---@field unk_2 number
local mental_picture_property_datest
...
---@field unk_3 number
---@field unk_4 number
local mental_picture_property_actionst
...
---@field unk_2 number
---@field unk_3 number
local mental_picture_property_toolst
...
---@field unk_1 number
---@field unk_2 number
local mental_picture_property_emotionst
...
---@field unk_1 number
---@field unk_2 number
local mental_picture_property_color_patternst
...
---@field unk_1 number
---@field unk_2 number
local mental_picture_property_shapest
...
---@field unk_1 number
---@field unk_2 number
local mental_picture_property_adjectivest
...
---@field unk_2 number
---@field unk_3 number
local mental_picture_property_positionst
...
---@field unk_2 number
---@field unk_3 number
local mental_picture_property_timest
...
---@field unk_1 number
local mental_picture_element_hfst
...
---@field unk_1 number
local mental_picture_element_sitest
...
---@field unk_1 number
local mental_picture_element_regionst
...
local history_event_reason_info
...
local history_event_reason_info_data
...
local history_event_circumstance_info
...
local history_event_circumstance_info_data
...
local history_event_context

---@class _history_event_context: DFCompound
---@field _kind 'struct-type'
df.history_event_context = {}

---@alias _history_event_context.T_flags_keys
---| 0 # is_interrogation_report
---| 1 # do_markup

---@alias _history_event_context.T_flags_values
---| "is_interrogation_report" # 0
---| "do_markup" # 1

---@class history_event_context.T_flags: DFObject, { [_history_event_context.T_flags_keys|_history_event_context.T_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_context.T_flags
local history_event_context_flags = {
  is_interrogation_report = false,
  [0] = false,
  do_markup = false,
  [1] = false,
}
...
---@alias _merc_role_type_keys
---| 0 # attacker_scout
---| 1 # defender_scout

---@alias _merc_role_type_values
---| "attacker_scout" # 0
---| "defender_scout" # 1

---@class merc_role_type: DFObject, { [_merc_role_type_keys|_merc_role_type_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _merc_role_type
local merc_role_type = {
  attacker_scout = false,
  [0] = false,
  defender_scout = false,
  [1] = false,
}
...
local history_event_war_attacked_sitest
...
---@field site number References: `world_site`
---@field unk_1 number
local history_event_war_destroyed_sitest
...
local history_event_created_sitest
...
local history_event_hist_figure_diedst
...
local history_event_add_hf_entity_linkst
...
---@field link_type histfig_entity_link_type
---@field position_id number index into entity.positions.own
local history_event_remove_hf_entity_linkst
...
---@field site number References: `world_site`
local history_event_entity_expels_hfst
...
---@field site number References: `world_site`
local history_event_first_contactst
...
---@field site number References: `world_site`
local history_event_first_contact_failedst
...
local history_event_topicagreement_concludedst
...
---@field destination number References: `historical_entity`
---@field site number References: `world_site`
local history_event_topicagreement_rejectedst
...
---@field destination number References: `historical_entity`
---@field site number References: `world_site`
local history_event_topicagreement_madest
...
---@field destination number References: `historical_entity`
---@field site number References: `world_site`
local history_event_war_peace_acceptedst
...
---@field destination number References: `historical_entity`
---@field site number References: `world_site`
local history_event_war_peace_rejectedst
...
---@field site number References: `world_site`
local history_event_diplomat_lostst
...
---@field source number References: `historical_entity`
---@field destination number References: `historical_entity`
local history_event_agreements_voidedst
...
---@field destination number References: `historical_entity`
---@field site number References: `world_site`
local history_event_merchantst
...
---@field histfig number References: `historical_figure`
---@field site number References: `world_site`
local history_event_artifact_hiddenst
...
local history_event_artifact_possessedst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_artifact_createdst

---@class _history_event_artifact_createdst: DFCompound
---@field _kind 'class-type'
df.history_event_artifact_createdst = {}

---@alias _history_event_artifact_createdst.T_flags2_keys
---| 0 # name_only

---@alias _history_event_artifact_createdst.T_flags2_values
---| "name_only" # 0

---@class history_event_artifact_createdst.T_flags2: DFObject, { [_history_event_artifact_createdst.T_flags2_keys|_history_event_artifact_createdst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_artifact_createdst.T_flags2
local history_event_artifact_createdst_flags2 = {
  name_only = false,
  [0] = false,
}
...
local history_event_artifact_lostst
...
local history_event_artifact_foundst
...
local history_event_artifact_recoveredst
...
---@field histfig number References: `historical_figure`
---@field site number References: `world_site`
local history_event_artifact_droppedst
...
local history_event_reclaim_sitest

---@class _history_event_reclaim_sitest: DFCompound
---@field _kind 'class-type'
df.history_event_reclaim_sitest = {}

---@alias _history_event_reclaim_sitest.T_flags2_keys
---| 0 # unretire

---@alias _history_event_reclaim_sitest.T_flags2_values
---| "unretire" # 0

---@class history_event_reclaim_sitest.T_flags2: DFObject, { [_history_event_reclaim_sitest.T_flags2_keys|_history_event_reclaim_sitest.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_reclaim_sitest.T_flags2
local history_event_reclaim_sitest_flags2 = {
  unretire = false,
  [0] = false,
}
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_hf_destroyed_sitest
...
local history_event_site_diedst

---@class _history_event_site_diedst: DFCompound
---@field _kind 'class-type'
df.history_event_site_diedst = {}

---@alias _history_event_site_diedst.T_flags2_keys
---| 0 # abandoned

---@alias _history_event_site_diedst.T_flags2_values
---| "abandoned" # 0

---@class history_event_site_diedst.T_flags2: DFObject, { [_history_event_site_diedst.T_flags2_keys|_history_event_site_diedst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_site_diedst.T_flags2
local history_event_site_diedst_flags2 = {
  abandoned = false,
  [0] = false,
}
...
local history_event_site_retiredst

---@class _history_event_site_retiredst: DFCompound
---@field _kind 'class-type'
df.history_event_site_retiredst = {}

---@alias _history_event_site_retiredst.T_flags2_keys
---| 0 # first_time

---@alias _history_event_site_retiredst.T_flags2_values
---| "first_time" # 0

---@class history_event_site_retiredst.T_flags2: DFObject, { [_history_event_site_retiredst.T_flags2_keys|_history_event_site_retiredst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_site_retiredst.T_flags2
local history_event_site_retiredst_flags2 = {
  first_time = false,
  [0] = false,
}
...
local history_event_entity_createdst
...
local history_event_entity_actionst
...
local history_event_entity_incorporatedst
...
local history_event_created_buildingst
...
local history_event_replaced_buildingst
...
local history_event_add_hf_site_linkst
...
---@field civ number References: `historical_entity`
---@field type histfig_site_link_type
local history_event_remove_hf_site_linkst
...
local history_event_add_hf_hf_linkst
...
---@field hf_target number References: `historical_figure`
---@field type histfig_hf_link_type
local history_event_remove_hf_hf_linkst
...
---@field site number References: `world_site`
---@field structure number References: `abstract_building`
local history_event_entity_razed_buildingst
...
local history_event_masterpiece_createdst
...
---@field unk_2 number
local history_event_masterpiece_created_arch_constructst
...
local history_event_masterpiece_created_itemst
...
local history_event_masterpiece_created_dye_itemst
...
local history_event_masterpiece_created_item_improvementst
...
---@field item_subtype number
---@field item_id number References: `item`
local history_event_masterpiece_created_foodst
...
---@field art_id number References: `art_image_chunk`
---@field art_subid number References: `art_image`
local history_event_masterpiece_created_engravingst
...
local history_event_masterpiece_lostst
...
local history_event_change_hf_statest
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_change_hf_jobst
...
---@field defender_merc_enid number References: `historical_entity`
---@field merc_roles merc_role_type
local history_event_war_field_battlest
...
local history_event_war_plundered_sitest
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_war_site_new_leaderst
...
local history_event_war_site_tribute_forcedst

---@class _history_event_war_site_tribute_forcedst: DFCompound
---@field _kind 'class-type'
df.history_event_war_site_tribute_forcedst = {}

---@alias _history_event_war_site_tribute_forcedst.T_tribute_flags_keys
---| 0 # bled_dry

---@alias _history_event_war_site_tribute_forcedst.T_tribute_flags_values
---| "bled_dry" # 0

---@class history_event_war_site_tribute_forcedst.T_tribute_flags: DFObject, { [_history_event_war_site_tribute_forcedst.T_tribute_flags_keys|_history_event_war_site_tribute_forcedst.T_tribute_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_war_site_tribute_forcedst.T_tribute_flags
local history_event_war_site_tribute_forcedst_tribute_flags = {
  bled_dry = false, -- tribute was demanded, but not received
  [0] = false, -- tribute was demanded, but not received
}
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_war_site_taken_overst
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_site_surrenderedst
...
local history_event_body_abusedst
...
local history_event_body_abusedst_abuse_data
...
---@field mat_type number References: `material`
---@field mat_index number
local history_event_body_abusedst_abuse_data_Impaled
...
local history_event_body_abusedst_abuse_data_Piled
...
---@field structure number References: `abstract_building`
local history_event_body_abusedst_abuse_data_Flayed
...
local history_event_body_abusedst_abuse_data_Hung
...
---@field unk_2 number
---@field unk_3 number
local history_event_body_abusedst_abuse_data_Animated
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hist_figure_abductedst
...
local history_event_item_stolenst
...
---@field site number References: `world_site`
---@field structure number References: `abstract_building`
local history_event_hf_razed_buildingst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_creature_devouredst
...
local history_event_hist_figure_woundedst
...
---@alias _history_event_hist_figure_woundedst.T_flags2_keys
---| 0 # torture

---@alias _history_event_hist_figure_woundedst.T_flags2_values
---| "torture" # 0

---@class history_event_hist_figure_woundedst.T_flags2: DFObject, { [_history_event_hist_figure_woundedst.T_flags2_keys|_history_event_hist_figure_woundedst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_hist_figure_woundedst.T_flags2
local history_event_hist_figure_woundedst_flags2 = {
  torture = false,
  [0] = false,
}
...
local history_event_hist_figure_simple_battle_eventst
...
local history_event_created_world_constructionst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hist_figure_reunionst
...
---@field layer number References: `world_underground_region`
---@field region_pos coord2d
local history_event_hist_figure_reach_summitst
...
---@field region_pos coord2d
local history_event_hist_figure_travelst
...
---@field layer number References: `world_underground_region`
---@field region_pos coord2d
local history_event_hist_figure_new_petst
...
local history_event_assume_identityst
...
local history_event_create_entity_positionst
...
local history_event_change_creature_typest
...
---@field interaction number References: `interaction`
---@field unk_1 number
local history_event_hist_figure_revivedst

---@class _history_event_hist_figure_revivedst: DFCompound
---@field _kind 'class-type'
df.history_event_hist_figure_revivedst = {}

---@alias _history_event_hist_figure_revivedst.T_flags2_keys
---| 0 # again

---@alias _history_event_hist_figure_revivedst.T_flags2_values
---| "again" # 0

---@class history_event_hist_figure_revivedst.T_flags2: DFObject, { [_history_event_hist_figure_revivedst.T_flags2_keys|_history_event_hist_figure_revivedst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_hist_figure_revivedst.T_flags2
local history_event_hist_figure_revivedst_flags2 = {
  again = false,
  [0] = false,
}
...
---@field interaction number References: `interaction`
---@field unk_1 number
local history_event_hf_learns_secretst
...
---@field layer number References: `world_underground_region`
---@field region_pos coord2d
local history_event_change_hf_body_statest
...
---@field site number References: `world_site`
---@field structure number References: `abstract_building`
local history_event_hf_act_on_buildingst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hf_does_interactionst
...
---@field layer number References: `world_underground_region`
---@field region_pos coord2d
local history_event_hf_confrontedst
...
local history_event_entity_lawst

---@class _history_event_entity_lawst: DFCompound
---@field _kind 'class-type'
df.history_event_entity_lawst = {}

---@alias _history_event_entity_lawst.T_add_flags_keys
---| 0 # harsh

---@alias _history_event_entity_lawst.T_add_flags_values
---| "harsh" # 0

---@class history_event_entity_lawst.T_add_flags: DFObject, { [_history_event_entity_lawst.T_add_flags_keys|_history_event_entity_lawst.T_add_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_entity_lawst.T_add_flags
local history_event_entity_lawst_add_flags = {
  harsh = false,
  [0] = false,
}
...
---@alias _history_event_entity_lawst.T_remove_flags_keys
---| 0 # harsh

---@alias _history_event_entity_lawst.T_remove_flags_values
---| "harsh" # 0

---@class history_event_entity_lawst.T_remove_flags: DFObject, { [_history_event_entity_lawst.T_remove_flags_keys|_history_event_entity_lawst.T_remove_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_entity_lawst.T_remove_flags
local history_event_entity_lawst_remove_flags = {
  harsh = false,
  [0] = false,
}
...
local history_event_hf_gains_secret_goalst
...
local history_event_artifact_storedst
...
local history_event_agreement_formedst
...
local history_event_site_disputest
...
local history_event_agreement_concludedst
...
---@field site number References: `world_site`
local history_event_insurrection_startedst
...
local history_event_insurrection_endedst
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_hf_attacked_sitest
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_performancest
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_competitionst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_processionst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_ceremonyst
...
---@field first number
local history_event_knowledge_discoveredst
...
---@field histfig number References: `historical_figure`
---@field site number References: `world_site`
local history_event_artifact_transformedst
...
local history_event_artifact_destroyedst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hf_relationship_deniedst
...
---@field join_entity number References: `historical_entity`
---@field site number References: `world_site`
local history_event_regionpop_incorporated_into_entityst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_poetic_form_createdst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_musical_form_createdst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_dance_form_createdst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_written_content_composedst
...
---@field layer number References: `world_underground_region`
---@field region_pos coord2d
local history_event_change_hf_moodst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_artifact_claim_formedst
...
local history_event_artifact_givenst
...
---@field site number References: `world_site`
---@field structure number References: `abstract_building`
local history_event_hf_act_on_artifactst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hf_recruited_unit_type_for_entityst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hfs_formed_reputation_relationshipst
...
local history_event_artifact_copiedst

---@class _history_event_artifact_copiedst: DFCompound
---@field _kind 'class-type'
df.history_event_artifact_copiedst = {}

---@alias _history_event_artifact_copiedst.T_flags2_keys
---| 0 # from_original

---@alias _history_event_artifact_copiedst.T_flags2_values
---| "from_original" # 0

---@class history_event_artifact_copiedst.T_flags2: DFObject, { [_history_event_artifact_copiedst.T_flags2_keys|_history_event_artifact_copiedst.T_flags2_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_artifact_copiedst.T_flags2
local history_event_artifact_copiedst_flags2 = {
  from_original = false,
  [0] = false,
}
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_sneak_into_sitest
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_spotted_leaving_sitest
...
local history_event_entity_searched_sitest
...
---@field site_civ number References: `historical_entity`
---@field site number References: `world_site`
local history_event_hf_freedst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hist_figure_simple_actionst
...
---@field site_id number References: `world_site`
local history_event_entity_rampaged_in_sitest
...
---@field site_id number References: `world_site`
local history_event_entity_fled_sitest
...
local history_event_tactical_situationst

---@class _history_event_tactical_situationst: DFCompound
---@field _kind 'class-type'
df.history_event_tactical_situationst = {}

---@alias _history_event_tactical_situationst.T_tactics_flags_keys
---| 0 # start

---@alias _history_event_tactical_situationst.T_tactics_flags_values
---| "start" # 0

---@class history_event_tactical_situationst.T_tactics_flags: DFObject, { [_history_event_tactical_situationst.T_tactics_flags_keys|_history_event_tactical_situationst.T_tactics_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_tactical_situationst.T_tactics_flags
local history_event_tactical_situationst_tactics_flags = {
  start = false,
  [0] = false,
}
...
---@field subregion number References: `world_region`
---@field feature_layer number References: `world_underground_region`
local history_event_squad_vs_squadst
...
local history_event_add_entity_site_profile_flagst
...
local history_event_add_hf_entity_honorst
...
---@field circumstance history_event_circumstance_info
---@field reason history_event_reason_info
local history_event_entity_dissolvedst
...
local history_event_entity_equipment_purchasest
...
local history_event_modified_buildingst

---@class _history_event_modified_buildingst: DFCompound
---@field _kind 'class-type'
df.history_event_modified_buildingst = {}

---@alias _history_event_modified_buildingst.T_modification_keys
---| 0 # dungeon
---| 1 # fortifications
---| 2 # courtyard
---| 3 # feast_hall

---@alias _history_event_modified_buildingst.T_modification_values
---| "dungeon" # 0
---| "fortifications" # 1
---| "courtyard" # 2
---| "feast_hall" # 3

---@class history_event_modified_buildingst.T_modification: DFObject, { [_history_event_modified_buildingst.T_modification_keys|_history_event_modified_buildingst.T_modification_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_modified_buildingst.T_modification
local history_event_modified_buildingst_modification = {
  dungeon = false,
  [0] = false,
...
---@field unk_1 number
local history_event_building_profile_acquiredst
...
local history_event_hf_preachst
...
local history_event_entity_persecutedst
...
---@field layer number References: `world_underground_region`
local history_event_entity_breach_feature_layerst
...
---@field entity number References: `historical_entity`
local history_event_entity_alliance_formedst
...
local history_event_hf_ransomedst
...
---@field payer_entity number References: `historical_entity`
---@field moved_to_site number References: `world_site`
local history_event_hf_enslavedst
...
---@field target_entity number References: `historical_entity`
---@field site number References: `world_site`
local history_event_sabotagest
...
---@field site number References: `world_site`
local history_event_entity_overthrownst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_hfs_formed_intrigue_relationshipst
...
---@field region number References: `world_region`
---@field layer number References: `world_underground_region`
local history_event_failed_intrigue_corruptionst
...
local history_event_hf_convictedst

---@class _history_event_hf_convictedst: DFCompound
---@field _kind 'class-type'
df.history_event_hf_convictedst = {}

---@alias _history_event_hf_convictedst.T_punishment_flags_keys
---| 0 # beaten
---| 1 # exiled
---| 2 # death_sentence
---| 3 # no_prison_available

---@alias _history_event_hf_convictedst.T_punishment_flags_values
---| "beaten" # 0
---| "exiled" # 1
---| "death_sentence" # 2
---| "no_prison_available" # 3

---@class history_event_hf_convictedst.T_punishment_flags: DFObject, { [_history_event_hf_convictedst.T_punishment_flags_keys|_history_event_hf_convictedst.T_punishment_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_hf_convictedst.T_punishment_flags
local history_event_hf_convictedst_punishment_flags = {
  beaten = false,
  [0] = false,
  exiled = false,
  [1] = false,
  death_sentence = false, -- sentenced to death
  [2] = false, -- sentenced to death
  no_prison_available = false, -- would have been imprisoned but for lack of accommodations
  [3] = false, -- would have been imprisoned but for lack of accommodations
}
...
---@alias _history_event_hf_convictedst.T_plot_flags_keys
---| 0 # wrongful
---| 1 # plot_surveillance
---| 2 # target_surveillance
---| 3 # implicated_others
---| 4 # co_conspirator_surveillance
---| 5 # go_between
---| 6 # revealed_nothing

---@alias _history_event_hf_convictedst.T_plot_flags_values
---| "wrongful" # 0
---| "plot_surveillance" # 1
---| "target_surveillance" # 2
---| "implicated_others" # 3
---| "co_conspirator_surveillance" # 4
---| "go_between" # 5
---| "revealed_nothing" # 6

---@class history_event_hf_convictedst.T_plot_flags: DFObject, { [_history_event_hf_convictedst.T_plot_flags_keys|_history_event_hf_convictedst.T_plot_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_hf_convictedst.T_plot_flags
local history_event_hf_convictedst_plot_flags = {
  wrongful = false, -- wrongful conviction
  [0] = false, -- wrongful conviction
  plot_surveillance = false, -- due to ongoing surveillance as the plot unfolded
  [1] = false, -- due to ongoing surveillance as the plot unfolded
  target_surveillance = false, -- due to ongoing surveillance on the target
  [2] = false, -- due to ongoing surveillance on the target
  implicated_others = false, -- implicated others during interrogation
  [3] = false, -- implicated others during interrogation
  co_conspirator_surveillance = false, -- due to ongoing surveillance on a coconspirator
  [4] = false, -- due to ongoing surveillance on a coconspirator
  go_between = false, -- convicted as go-between
  [5] = false, -- convicted as go-between
  revealed_nothing = false, -- revealed nothing during interrogation
  [6] = false, -- revealed nothing during interrogation
}
...
---@field framer_hf number References: `historical_figure`
---@field crime number references crime::T_mode
local history_event_failed_frame_attemptst
...
local history_event_hf_interrogatedst

---@class _history_event_hf_interrogatedst: DFCompound
---@field _kind 'class-type'
df.history_event_hf_interrogatedst = {}

---@alias _history_event_hf_interrogatedst.T_interrogation_flags_keys
---| 0 # recognized
---| 1 # refused_to_reveal

---@alias _history_event_hf_interrogatedst.T_interrogation_flags_values
---| "recognized" # 0
---| "refused_to_reveal" # 1

---@class history_event_hf_interrogatedst.T_interrogation_flags: DFObject, { [_history_event_hf_interrogatedst.T_interrogation_flags_keys|_history_event_hf_interrogatedst.T_interrogation_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _history_event_hf_interrogatedst.T_interrogation_flags
local history_event_hf_interrogatedst_interrogation_flags = {
  recognized = false,
  [0] = false,
  refused_to_reveal = false,
  [1] = false,
}
...
local history_event_collection_vector
...
local history_event_collection_warst
...
local history_event_collection_warst_unk
...
local history_event_collection_battlest
...
local history_event_collection_duelst
...
---@field ordinal number
local history_event_collection_site_conqueredst
...
---@field defender_civ number References: `historical_entity`
---@field ordinal number
local history_event_collection_abductionst
...
---@field ordinal number
local history_event_collection_theftst
...
---@field defender_civ number References: `historical_entity`
---@field ordinal number
local history_event_collection_beast_attackst
...
---@field ordinal number
local history_event_collection_journeyst
...
---@field target_civ number References: `historical_entity`
---@field ordinal number
local history_event_collection_insurrectionst
...
---@field occasion number
---@field ordinal number
local history_event_collection_occasionst
...
---@field ordinal number
local history_event_collection_performancest
...
---@field unk_2 number 0-9 seen
---@field ordinal number
local history_event_collection_competitionst
...
---@field unk_2 number 0-9 seen
---@field ordinal number
local history_event_collection_processionst
...
---@field ordinal number
local history_event_collection_ceremonyst
...
---@field ordinal number
local history_event_collection_purgest
...
---@field defender_civ number References: `historical_entity`
---@field ordinal number
local history_event_collection_raidst
...
---@field entity number References: `historical_entity`
---@field ordinal number
local history_event_collection_persecutionst
...
---@field entity number References: `historical_entity`
---@field ordinal number
local history_event_collection_entity_overthrownst
...
local relationship_event_supplement
...
local world_history_event_collections
...
---@alias _intrigue_corruption.T_flags_keys
---| 0 # succeeded
---| 1 # misread_target

---@alias _intrigue_corruption.T_flags_values
---| "succeeded" # 0
---| "misread_target" # 1

---@class intrigue_corruption.T_flags: DFObject, { [_intrigue_corruption.T_flags_keys|_intrigue_corruption.T_flags_values]: boolean }
---@field _kind 'bitfield'
---@field _enum _intrigue_corruption.T_flags
local intrigue_corruption_flags = {
  succeeded = false,
  [0] = false,
  misread_target = false,
  [1] = false,
}
