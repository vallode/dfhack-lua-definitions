...
---@class (exact) _item_type: df.struct
---@field NONE -1
---@field [0] "NONE"
---@field BAR 1
---@field [1] "BAR"
...
---@class (exact) _weapon_attack_flags: df.struct
...
---@class (exact) _itemdef_flags: df.struct
---@field GENERATED 0
---@field [0] "GENERATED"
df.itemdef_flags = {}
...
---@class (exact) _ammo_flags: df.struct
...
---@class (exact) _armor_general_flags: df.struct
---@field SOFT 0
---@field [0] "SOFT"
---@field HARD 1
---@field [1] "HARD"
...
---@class (exact) _armor_flags: df.struct
...
---@class (exact) _gloves_flags: df.struct
---@field METAL_ARMOR_LEVELS 0
---@field [0] "METAL_ARMOR_LEVELS"
df.gloves_flags = {}
...
---@class (exact) _helm_flags: df.struct
---@field METAL_ARMOR_LEVELS 0
---@field [0] "METAL_ARMOR_LEVELS"
df.helm_flags = {}
...
---@class (exact) _instrument_flags: df.struct
...
---@class (exact) _sound_production_type: df.struct
...
---@class (exact) _pitch_choice_type: df.struct
...
---@class (exact) _tuning_type: df.struct
---@field PEGS 0
---@field [0] "PEGS"
...
---@class (exact) _timbre_type: df.struct
---@field CLEAR 0
---@field [0] "CLEAR"
---@field NOISY 1
---@field [1] "NOISY"
...
---@class (exact) _instrument_piece_flags: df.struct
...
---@class (exact) _pants_flags: df.struct
---@field METAL_ARMOR_LEVELS 0
---@field [0] "METAL_ARMOR_LEVELS"
df.pants_flags = {}
...
---@class (exact) _shoes_flags: df.struct
---@field METAL_ARMOR_LEVELS 0
---@field [0] "METAL_ARMOR_LEVELS"
df.shoes_flags = {}
...
---@class (exact) _tool_flags: df.struct
---@field HARD_MAT 0
---@field [0] "HARD_MAT"
---@field METAL_MAT 1
---@field [1] "METAL_MAT"
...
---@class (exact) _tool_uses: df.struct
---@field NONE -1
---@field [0] "NONE"
...
---@class (exact) _toy_flags: df.struct
---@field HARD_MAT 0
---@field [0] "HARD_MAT"
df.toy_flags = {}
...
---@class (exact) _trapcomp_flags: df.struct
---@field IS_SCREW 0
---@field [0] "IS_SCREW"
---@field IS_SPIKE 1
---@field [1] "IS_SPIKE"
...
---@class (exact) _weapon_flags: df.struct
---@field CAN_STONE 0
---@field [0] "CAN_STONE"
